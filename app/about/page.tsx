...
export const metadata:Metadata={title:"About | 4Ever Seasons",description:"Learn how 4Ever Seasons approaches reliable property care across Oakville, Burlington and Hamilton."};
