...
export default function MasterPage(){
  ...
  useEffect(()=>{let alive=true;void(async()=>{
    ...
    if(!alive)return;setProfile(p);setCompanies(companyResult.companies||[]);setLeads(companyResult.leads||[]);setRequests(companyResult.requests||[]);setAudit(companyResult.audit||[]);setMembers(companyResult.members||[]);setMessage("");setLoading(false);
