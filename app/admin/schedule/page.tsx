...
import { assignJobToCrew, loadSchedulingDispatchBoard, schedulingBoardToLeads } from "@/lib/services/schedulingService";
...
export default function Schedule(){
  ...
  return <AdminShell active="Dispatch">
    ...
    <section className="card profile-card" style={{marginBottom:20}}>
      <div className="table-head"><div><h2>Assign Customers</h2><p className="section-intro">Choose one or many active service jobs and assign them permanently to a crew. The service day is selected later in Routes.</p></div><span className="pill">{selected.length} selected</span></div>
      ...
      <div className="row" style={{marginTop:16}}>
        ...
        <button className="btn btn-primary" disabled={busy} onClick={()=>void assignSelected()}>{busy?"Assigning…":"Assign to Crew"}</button>
      </div>
