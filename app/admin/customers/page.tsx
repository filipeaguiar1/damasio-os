...
export default function Customers() {
  ...
  return <AdminShell active="Customers">
    ...
    <div className="stats v19-stats"><div className="card dash-card"><div className="mini-label">Today's homes</div><div className="mini-value">{today.completed}/{today.homes}</div></div><div className="card dash-card"><div className="mini-label">Today's tasks</div><div className="mini-value">{today.tasksCompleted}/{today.tasks}</div></div><div className="card dash-card"><div className="mini-label">Pending offers</div><div className="mini-value">{offers.length}</div></div><div className="card dash-card"><div className="mini-label">Active customers</div><div className="mini-value">{records.length}</div></div></div>
