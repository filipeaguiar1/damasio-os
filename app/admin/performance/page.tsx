...
export default function PerformancePage(){
  ...
  return <AdminShell active="Performance">
    <div className="app-top"><div><span className="eyebrow">Admin Only</span><h1>Employee Performance</h1><p className="section-intro">Ratings, tips, photos, service time metrics and operational planning.</p></div><div style={{display:"flex",gap:10,flexWrap:"wrap"}}><Link className="btn btn-primary" href="/admin/performance/simulator">Open Simulator</Link><button className="btn btn-outline" onClick={()=>{seedDemoLeads(true);refresh()}}>Load Demo</button></div></div>
