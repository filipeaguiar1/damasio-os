...
const groups=[["Customers","◎","/mobile/admin/customers"],["Estimates","▤","/mobile/admin/estimates"],["Invoices","$","/mobile/admin/invoices"],["Requests","＋","/mobile/admin/requests"],["Employees","♧","/mobile/admin/employees"],["Finance","◈","/mobile/admin/finance"],["Reports","▥","/mobile/admin/reports"],["Settings","⚙","/mobile/admin/settings"]];
